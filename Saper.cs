...

{
...

    {
...

        {
            ...
            Console.WriteLine("Podaj wspó³rzêdne (x, y) do odkrycia (np. 2 3): ");
...

            {
...

                {
...

                    {
...

                        {
                            ...
                            Console.WriteLine("Gratulacje! Wygra³eœ!");
...

                {
                    ...
                    Console.WriteLine("Nieprawid³owe wspó³rzêdne. Spróbuj ponownie.");
...

            {
                ...
                Console.WriteLine("Nieprawid³owe dane wejœciowe. Spróbuj ponownie.");
...

    {
        ...
        // Wype³nij planszê niewidocznymi polami.
